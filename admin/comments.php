...
<tr>
	...
	<td><a id="inline" class="fancybox btn btn-info" href="#inline<?php echo $i;?>">Show</a>
	...
	<td><a id="inline" class="fancybox btn btn-info" href="#inline<?php echo $i.$i;?>"><?php echo $row['post_id'];?></a>
	...
	<td><a class="btn btn-success" href="comments.php?id=<?php echo $row['c_id'];?>">Approve</a></td>
</tr>  
<?php	
}
?>
